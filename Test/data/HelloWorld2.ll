...
@llvm.used = appending global [1 x i8*] [i8* bitcast (void ()* @helloWorld2 to i8*)], section "llvm.metadata"

define external default void @helloWorld2() {
entry:
...
!0 = metadata !{void ()* @helloWorld2, metadata !"kernel", i32 1}
